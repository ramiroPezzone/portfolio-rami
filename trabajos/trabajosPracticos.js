const trabajosPracticos = [
  {
    ...
    demoResponsive: "demoResponsiveTP3.png",
  ...
  },
  {
    ...
    imagen: "vista-previa-tp2.png",
    demoResponsive: "demoResponsiveTP2.png",
    tecnologias: "HTML - CSS - JS",
    descripcion:
      "Trabajo práctico individual en el cual debían demostrarse conocimientos adquiridos del manejo del DOM por medio de JS y de consumo de APIs. La misma debía contar con una sección de productos, un formulario de registro para los clientes y otra sección en la cual se consuma una API solicitando ciertos datos específicos de un array. El uso de JS consistió en el manejo de ciertos eventos (onClick, onSubmit, onFocus y onBlur) y en la manipulación de ciertos elementos del DOM como son asignación de color y tamaño.",
    observaciones:
